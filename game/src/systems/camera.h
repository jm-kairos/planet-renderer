...
public:
	...
	void update(double deltaSeconds, const MATH_VEC2_r32& mousePos, bool mousePressed)
	{
		if (mousePressed)
		{
			const glm::vec2 delta = glm::vec2(mousePos.x - mousePos_.x, mousePos.y - mousePos_.y);
		...
		mousePos_ = glm::vec2(mousePos.x, mousePos.y);
